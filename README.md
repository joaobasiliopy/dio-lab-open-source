...
4. Crie uma nova **branch** e nomeie como `feat/community/seunomedeusuario`: `git checkout -b feat/community/joaobasiliopy`;
    > Exemplo: `git checkout -b feat/community/joaobasiliopy`
